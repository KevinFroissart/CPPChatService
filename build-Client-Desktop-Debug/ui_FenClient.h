...
public:
    ...
    {
        FenClient->setWindowTitle(QApplication::translate("FenClient", "CPP CHAT SERVICE", Q_NULLPTR));
        ...
        label_6->setText(QApplication::translate("FenClient", "CPP CHAT SERVICE", Q_NULLPTR));
